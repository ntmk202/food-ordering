  ...
  <div id="main">
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Order Food</a>
                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-action-question-answer"></i> Contact</a>
                            <div class="collapsible-body">
                                <ul>
								<li class="<?php
								if(!isset($_GET['status'])){
									...
									"><a href="tickets.php">All messages</a>
                                </li>
								<?php
      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Chat</h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">If you're experiencing any issues, contact us by opening a messages.</p>
          <div class="divider"></div>
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Open a messages</h4>
              </div>
<div>
      ...
      <!-- END CONTENT -->
	        ...
	        <!--start container-->
        <div class="container">
          <p class="caption">List of your messages</p>
          <div class="divider"></div>
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 2021 <a class="grey-text text-lighten-4" href="#" target="_blank"></a> All rights reserved.</span>
